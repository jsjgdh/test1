...
export const Component = () => {
  ...
  const getLocation = () => {
    const { current: refs } = threeRefs as any;
    const locations: number[] = [];
    (refs.mountains as any[]).forEach((mountain: any, i: number) => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Update stars
      (refs.stars as any[]).forEach((starField: any, i: number) => {
    ...
    return () => {
      ...
      (refs.stars as any[]).forEach((starField: any) => {
        starField.geometry.dispose();
        starField.material.dispose();
      });

      (refs.mountains as any[]).forEach((mountain: any) => {
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            What’s been building quietly is almost ready.
          </p>
          <p className="subtitle-line">
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string }> = {
            0: {
              line1: 'What’s been building quietly is almost ready.',
              line2: ''
            },
            1: {
              line1: 'Something new is about to open up.',
              line2: ''
            },
            2: {
              line1: 'If you’re here, you’re meant to be part of what’s coming next.',
              line2: ''
            }
          };
              ...
              <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
                ...
                {titles[i+1] === 'DISCOVERY' && (
                  <form onSubmit={handleSubscribe} className="subscribe-form">
                    ...
                    {status === 'error' && (
                      <div className="subscribe-error">Something went wrong. Try again.</div>
                    )}
                  </form>
                )}
              </div>
